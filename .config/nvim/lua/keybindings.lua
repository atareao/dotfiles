...
--
keymap("n", "<leader>0", "<Plug>(cokeline-focus-0)", "Tab 0")
keymap("n", "<leader>1", "<Plug>(cokeline-focus-1)", "Tab 1")
keymap("n", "<leader>2", "<Plug>(cokeline-focus-2)", "Tab 2")
keymap("n", "<leader>3", "<Plug>(cokeline-focus-3)", "Tab 3")
keymap("n", "<leader>4", "<Plug>(cokeline-focus-4)", "Tab 4")
keymap("n", "<leader>5", "<Plug>(cokeline-focus-5)", "Tab 5")
keymap("n", "<leader>6", "<Plug>(cokeline-focus-6)", "Tab 6")
keymap("n", "<leader>7", "<Plug>(cokeline-focus-7)", "Tab 7")
keymap("n", "<leader>8", "<Plug>(cokeline-focus-8)", "Tab 8")
keymap("n", "<leader>9", "<Plug>(cokeline-focus-9)", "Tab 9")
