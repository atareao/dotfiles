...
keymap("n", "\\", "<cmd>Neotree reveal<cr>", "Reveal file in Neotree")
keymap("n", "&", ":&&<CR>", "Repeat last substitution")
keymap("n", "<C-L>", "<cmd>nohlsearch<bar>diffupdate<bar>normal! <C-L><CR>", "Clear search + redraw")
keymap("i", "<C-W>", "<C-G>u<C-W>", "Delete word with undo point")
keymap("i", "<C-U>", "<C-G>u<C-U>", "Delete line with undo point")
--
...
keymap("n", "<A-i>", "<cmd>Atone toggle<cr>", "Atone")
...
-- Neo-tree
keymap("n", "<leader>n", "<cmd>Neotree toggle<cr>", "NeoTree")
...
keymap("n", "<leader>dtc", "<cmd>lua require'telescope'.extensions.dap.commands{}<CR>", "DAP Commands")
keymap("n", "<leader>dto", "<cmd>lua require'telescope'.extensions.dap.configurations{}<CR>", "DAP Configs")
keymap("n", "<leader>dtb", "<cmd>lua require'telescope'.extensions.dap.list_breakpoints{}<CR>", "DAP Breakpoints")
keymap("n", "<leader>dtv", "<cmd>lua require'telescope'.extensions.dap.variables{}<CR>", "DAP Variables")
keymap("n", "<leader>dtf", "<cmd>lua require'telescope'.extensions.dap.frames{}<CR>", "DAP Frames")
...
keymap("n", "<leader>fn", "<cmd>BufferNext<cr>", "Focus next")
keymap("n", "<leader>fo", "<cmd>Telescope file_browser<cr>", "Commands")
keymap("n", "<leader>fp", "<cmd>BufferPrevious<cr>", "Focus preview")
...
keymap("n", "<leader>gl", "<cmd>Telescope git_bcommits<cr>", "Blame (buffer commits)")
...
keymap("n", "<leader>lD", "<cmd>lua vim.lsp.buf.declaration()<cr>", "Declaration")
keymap("n", "<leader>lf", "<cmd>lua vim.lsp.buf.format({ async = true })<cr>", "Format")
keymap("n", "<leader>lh", "<cmd>lua vim.lsp.buf.hover()<cr>", "Hover")
keymap("n", "<leader>li", "<cmd>lua vim.lsp.buf.signature_help()<cr>", "Signature Help")
keymap("n", "<leader>lr", "<cmd>lua vim.lsp.buf.rename()<cr>", "Rename")
keymap("n", "<leader>ls", "<cmd>lua vim.lsp.buf.document_symbol()<cr>", "Document Symbol")
keymap("n", "<leader>lt", "<cmd>lua vim.lsp.buf.type_definition()<cr>", "Type Definition")
...
keymap("n", "<leader>lJ", "<cmd>LspInstallInfo<cr>", "Installer Info")
...
keymap("n", "<leader>tt1", "<cmd>1ToggleTerm<cr>", "1")
keymap("n", "<leader>tt2", "<cmd>2ToggleTerm<cr>", "2")
keymap("n", "<leader>tt3", "<cmd>3ToggleTerm<cr>", "3")
keymap("n", "<leader>tt4", "<cmd>4ToggleTerm<cr>", "4")
...
-- Window
keymap("n", "<leader>w", "", "Window")
keymap("n", "<leader>wv", "<C-w>v", "Vertical Split")
keymap("n", "<leader>ws", "<C-w>s", "Horizontal Split")
...
keymap("n", "<C-w><C-d>", "<C-w>d", "Diff window close")
